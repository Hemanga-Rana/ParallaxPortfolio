...
Shery.hoverWithMediaCircle(".hvr" /* Element to target.*/, {
	images: ["project1.png", "project2.png", "project3.png", "project4.png"] /*OR*/,
...
document.addEventListener("DOMContentLoaded", function () {
	...
	gTl.to(".header__img", 2, { clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)", scale: 1, ease: "expo.out", delay: .5 }, "-=1");
